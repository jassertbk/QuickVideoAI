...
<head>
  ...
  <title>InVideo AI | Create Stunning Videos Fast with AI Script-to-Video Maker</title>
  <meta name="description" content="Create professional, engaging videos in minutes with InVideo AI. Perfect for marketers, educators, content creators. Supports multiple languages including Arabic. No editing skills needed!" />
  <meta name="keywords" content="AI video maker, InVideo tutorial, script to video, video editing AI, content creation tool, Arabic video maker, marketing videos, video templates, text to video, AI voiceover" />
  <meta name="robots" content="index, follow" />
  <meta name="author" content="InVideo AI" />
  
  <!-- Google Search Console verification meta tag -->
  <meta name="google-site-verification" content="Sw0bL9KWJT4ziryfV23X7s5D2ozPgHBH5UadR0uMsYI" />

  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    body {
      font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
      background: linear-gradient(-45deg, #fce4ec, #e3f2fd, #fffde7, #e8f5e9);
    ...
    .stars {
      background-image: url('https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Gold_Star.svg/240px-Gold_Star.svg.png');
...
<body>
  ...
  <main class="container" role="main" aria-label="InVideo AI video creation content">
    ...
    <section aria-labelledby="why-invideo-section-title">
